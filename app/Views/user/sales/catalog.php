            ...
            <div class="col-md-4 mb-4 medicine-card">
                <div class="card" style="width: 100%;">
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($mdlist->discount_price && $mdlist->discount_price > $mdlist->price): ?>
                            <p class="card-text mb-1">
                                <del class="text-danger">Rp. <?= number_format($mdlist->discount_price, 0, ',', '.') ?></del>
                            </p>
                        <?php endif; ?>
                        <p class="card-text font-weight-bold text-success">Rp. <?= number_format($mdlist->price, 0, ',', '.') ?></p>
